...
export const TRUE_SELF_TRAITS: ChoiceItem[] = [
  { id: 'neoteny', title: 'NEOTENY', cost: 'Grants +3 BP', description: "Body modification magic is so easy that most people can just choose what physical age they want to be. However, many Mages suffer from NDS (Neotenic Development Syndrome) which ensures they are small and adorable forever. In your day-to-day life, it will be hard to get people to take you seriously.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true1.png' },
  { id: 'spidey_sense', title: 'SPIDEY SENSE', cost: 'Costs -4 BP', description: "Mages are at their most vulnerable while in their true forms. With this, if you're going to be in danger, you will automatically transform without having to consciously decide to, right in the nick of time. This is best for those who plan on not keeping their identity a secret; it probably won't be too useful otherwise.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true2.png' },
  { id: 'magician', title: 'MAGICIAN', cost: 'Costs -Variable', description: "You can use your Blessings while in your true form; however, its total cost will be multiplied by 1.25x. If someone sees your true self using magic, it will be obvious that you're secretly a mage, though they won't necessarily know which mage. Can be purchased as many times as you want.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true3.png' },
  { id: 'y_chromosome', title: 'Y CHROMOSOME', cost: 'Costs 0 BP', description: "Oh my! You're a pseudo-Distortion! Mages are made in the image of the kidnapped child of God, whom Mother uses to bring all magic into the world. One in a million are born male. If you'll definitely be quite popular with the other mages. Your alter ego will be a boy too, albeit more androgynous.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true4.png' },
];

export const ALTER_EGO_TRAITS: ChoiceItem[] = [
  { id: 'unique_appearance', title: 'UNIQUE APPEARANCE', cost: 'Costs -2 BP', description: "Your overall shape stays the same, but you can modify other details. This can be as simple as changing your hair color, to as complex as making your hair style defy gravity, appear to be made of fire or the night sky, or making your skin purple and your eyes glow like sapphires. Get creative!", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true5.png' },
  { id: 'exotic_appearance', title: 'EXOTIC APPEARANCE', cost: 'Costs -2 BP', description: "Requires Unique Appearance. As long as you maintain a generally humanoid form, you can now add new features to your body altogether, like fur, weird ears, or whatever else springs to your mind. This is quite rare, so expect to really stand out even compared to your fellow mages.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true6.png' },
  { id: 'inhuman_appearance', title: 'INHUMAN APPEARANCE', cost: 'Costs -2 BP', description: "Requires Exotic Appearance. At this point, you don't even have to look vaguely humanoid. Such mages are extremely rare, so you'll definitely stand out, for better or worse. Create your monstrous form with 40 Beast Points on the Reference Page excluding options marked with an *.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true7.png' },
  { id: 'power_requirement', title: 'POWER REQUIREMENT', cost: 'Grants +4 BP', description: "There's something or another you need regularly, or your powers will gradually drain. It can range from natural things like sunlight, to products like a certain chemical, to even things like friendship or a true love's kiss. The rarer it is, the slower your power drains when you are parted from it.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true8.png' },
  { id: 'power_weakness', title: 'POWER WEAKNESS', cost: 'Grants +2-8 BP', description: "There's something or another you need to avoid, or it will temporarily sap you of your powers. It can range from physical objects like a certain crystal, to more aethereal things like a keyword or emotion. The more common it is, the less severe its effects are on you. Your enemies might figure out this weakness!", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true9.png' },
  { id: 'signature_vehicle', title: 'SIGNATURE VEHICLE', cost: 'Costs -4 BP and -1 FP', description: "Create a vehicle on the Reference Page using 30 Vehicle Points. For some reason, it will spawn at your location every time you transform to your alter ego. If it's destroyed, it will reappear the next time you transform again. Not super practical, but guarantees you lots of style points!", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true10.png' },
  { id: 'rival', title: 'RIVAL', cost: 'Grants +7 FP', description: "You have a self-professed rival! Their personality is seemingly fine-tuned to piss you off to the maximum possible extent, and their powers are almost designed to counter your own. No matter what you do, you can never seem to get rid of them for very long, and they're immune to psychic control.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true11.png' },
  { id: 'corporate_mascot', title: 'CORPORATE MASCOT', cost: 'Grants +6 BP', description: "Some lobby major company or another is sponsoring your career! They'll make life easier for you, at the cost of plastering their logo all over your dress, magical styles, and making you complete 4 Jobs from page 3 without the usual rewards. Some people will consider you a sellout.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/true12.png' },
];

export const UNIFORMS_DATA: ChoiceItem[] = [
    { id: 'idol', title: 'IDOL', cost: 'Costs -1 FP', description: "This describes a large variety of outfits, mostly typified by bright colors, frilly dresses, big bows, and other girly things. Based on musical performers, this sort of outfit has been getting very popular amongst the younger generation of mages.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni1.png' },
    { id: 'witchy', title: 'WITCHY', cost: 'Costs -1 FP', description: "This used to be the most popular uniform for many millennia, but nowadays it's just about tied with Idol. Nowadays, this aesthetic is associated with traditional mages and ancient (and often spooky) magic, though anybody can wear it.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni2.png' },
    { id: 'boyish', title: 'BOYISH', cost: 'Costs -1 FP', description: "Not everybody wants to be the peak of femininity. This aesthetic encapsulates a range of outfits typically worn by guys and tomboys. Tends to be a tad boring, but at least you will look more cool and professional, and will be taken more seriously.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni3.png' },
    { id: 'high_tech', title: 'HIGH TECH', cost: 'Costs -1 FP', description: "Pretty common in New Palisade, but you'll look kinda weird elsewhere. Still, these bodysuits and armor panels are just so comfortable and convenient! They even have hologram systems built in that let you browse the web from anywhere.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni4.png' },
    { id: 'animal_themed', title: 'ANIMAL-THEMED', cost: 'Costs -1 FP', description: "You're really trying to crank the cuteness dial up to maximum, huh? Well, you'll be well-liked wherever you go, but don't expect people to assume you're tough or competent. But maybe you want your enemies to underestimate you?", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni5.png' },
    { id: 'old_timey', title: 'OLD TIMEY', cost: 'Costs -1 FP', description: "About a century or two ago, these kinds of outfits looked like they were about to take off, but then the Idol aesthetic came along and stole the spotlight. Still, these dresses are the perfect balance of cuteness and professionalism.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni6.png' },
    { id: 'oriental', title: 'ORIENTAL', cost: 'Costs -1 FP', description: "While the 'witchy' aesthetic dominated elsewhere for most of history, mages in Jipangu have always had a completely different sort of traditional dress. You might get funny looks wearing it elsewhere, but it's the perfect mix of class and beauty.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni7.png' },
    { id: 'custom', title: 'CUSTOM', cost: 'Costs -1 FP', description: "Daringly defy fashion standards and come up with your own unique style! This will definitely help you stand out in a crowd, but who knows? If you get famous, other people might be inspired by your style. The sky's the limit with this option.", imageSrc: 'https://saviapple.neocities.org/Seinaru_Magecraft_Girls/img/Pg1/uni8.png' },
];
